...
(function () {
  ...
  var checkRoom = function (advert) {
    return housingRooms.value === 'any' ? true : advert.offer.rooms === Number(housingRooms.value);
  };

  var checkGuests = function (advert) {
    return housingGuests.value === 'any' ? true : advert.offer.guests === Number(housingGuests.value);
  };
